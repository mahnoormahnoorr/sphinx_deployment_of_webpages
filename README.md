...
Build will ne empty folder where files will store up after you run the webpage. For-example if you deploy webpage, 2 folders named as `doctress` and `html` will open in Build that will have other files and sub folder in it. 
